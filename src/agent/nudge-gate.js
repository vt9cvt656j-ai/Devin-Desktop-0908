...
//   · probeLoop / directionCheck / dynamicToolRoute —— 这三条的**旁边**（researchFirst 2026-09-05 拆了）
...
export const TOOL_WINDOW_NUDGES = ["probeLoop", "directionCheck", "dynamicToolRoute"];
