...
const EN = {
  ...
  "chat.nextSteps": "Next \u203a",
  "watch.btn": "Live watch",
  "watch.title": "Live watch",
  "watch.desc": "While you use the app, the IDE watches the preview console, the dev-server terminal, captured requests and app screens (by rule). When something breaks it opens a turn and fixes it by itself.",
  "watch.mode": "When something goes wrong",
  "watch.mode.auto": "Follow autonomy ({v})",
  "watch.mode.on": "Fix automatically",
  "watch.mode.ask": "Ask me first",
  "watch.mode.off": "Record only",
  "watch.policy.auto": "auto-fix",
  "watch.policy.ask": "ask first",
  "watch.policy.off": "off",
  "watch.sources": "Watching",
  "watch.source.any": "Any source",
  "watch.source.preview": "Preview console",
  "watch.source.terminal": "Dev-server terminal",
  "watch.source.capture": "Failed captured requests",
  "watch.source.screen": "App screen text (rules)",
  "watch.rules": "Rules: when … appears → do …",
  "watch.rule.pattern": "Text that appears (regex ok)",
  "watch.rule.app": "App name (screen rules)",
  "watch.rule.prompt": "What to do (empty = fix it)",
  "watch.rule.fix": "fix it",
  "watch.rule.add": "Add rule",
  "watch.rule.delete": "Delete rule",
  "watch.rule.invalid": "A rule needs the text to match (and the app name for screen rules).",
  "watch.recent": "Recent",
  "watch.recent.empty": "Nothing caught yet",
  "watch.ask.fix": "Fix it",
  "watch.ask.ignore": "Ignore",
  "watch.outcome.auto": "handled",
  "watch.outcome.ask": "asked",
  "watch.outcome.duplicate": "duplicate",
  "watch.outcome.rate_limited": "rate-limited",
  "watch.outcome.recorded": "recorded",
  "watch.outcome.dismissed": "ignored",
...
const ZH_CN = {
  ...
  "watch.btn": "实时监听",
  "watch.title": "实时监听",
  "watch.desc": "你用应用的时候，IDE 盯着预览页面的控制台、dev server 终端、抓包里的失败请求和应用界面（按规则）；出了问题自动开一轮去修，不用你把报错贴回来。",
  "watch.mode": "出问题时",
  "watch.mode.auto": "跟随执行节奏（{v}）",
  "watch.mode.on": "自动修",
  "watch.mode.ask": "先提示我",
  "watch.mode.off": "只记录",
  "watch.policy.auto": "自动修",
  "watch.policy.ask": "先提示",
  "watch.policy.off": "已关",
  "watch.sources": "盯什么",
  "watch.source.any": "任意来源",
  "watch.source.preview": "预览页面控制台",
  "watch.source.terminal": "dev server 终端",
  "watch.source.capture": "抓包的失败请求",
  "watch.source.screen": "应用界面文字（按规则）",
  "watch.rules": "规则：出现什么 → 做什么",
  "watch.rule.pattern": "出现的文字（可正则）",
  "watch.rule.app": "应用名（界面规则）",
  "watch.rule.prompt": "要做什么（留空 = 修掉）",
  "watch.rule.fix": "修掉",
  "watch.rule.add": "添加规则",
  "watch.rule.delete": "删除规则",
  "watch.rule.invalid": "规则要有要匹配的文字（界面规则还要应用名）。",
  "watch.recent": "最近发现",
  "watch.recent.empty": "还没发现问题",
  "watch.ask.fix": "自动修复",
  "watch.ask.ignore": "忽略",
  "watch.outcome.auto": "已自动处理",
  "watch.outcome.ask": "已提示",
  "watch.outcome.duplicate": "重复，已跳过",
  "watch.outcome.rate_limited": "触发过密，已跳过",
  "watch.outcome.recorded": "仅记录",
  "watch.outcome.dismissed": "已忽略",
  "subagent.worker": "worker",
