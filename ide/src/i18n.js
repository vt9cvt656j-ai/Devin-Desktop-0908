...
const EN = {
  ...
  "tool.action.office_write": "Office document",
  "tool.action.office_edit": "Edit document",
  "tool.action.office_read": "Read document",
  ...
  "assistant.prompt.initMemory": "Read this project end to end: README, dependency and build config, directory layout, entry points, and how it is run and tested. Then save the durable facts to project memory with the remember tool (scope project): stack and versions, architecture decisions, directory and naming conventions, the exact build/test/run commands, and any trap you hit together with its root cause. One fact per call. Finish by listing what you saved.",
  "assistant.prompt.securityReview": "Do a security review of this project's OWN code, not its dependencies: injection surfaces (SQL / command / path / template), authentication and authorization gaps, secrets or credentials committed to the repo, unsafe deserialization, SSRF, and missing input validation on anything reachable from outside. For each finding give the file and line, why it is exploitable, and the smallest fix. Skip anything you cannot point at real code for.",
  "assistant.prompt.listTodos": "Find the TODO / FIXME / HACK / XXX markers in this project, plus commented-out code that looks abandoned. Group them by area, say what each one is actually asking for, and rank them by what it costs to leave it. Call out the ones that are already stale because the surrounding code moved on.",
  ...
  "model.thinking.na": "Not adjustable",
  ...
  "feature.appearance.appSkin.section": "App skin",
  "feature.appearance.appSkin.label": "Custom skin",
  "feature.appearance.appSkin.hint": "Upload an image to sit behind the whole IDE. The chrome turns translucent so it shows through; code stays on a solid background so it never gets harder to read.",
  "feature.appearance.appSkin.upload": "Upload image",
  "feature.appearance.appSkin.replace": "Replace image",
  "feature.appearance.appSkin.processing": "Processing…",
  "feature.appearance.appSkin.reset": "Remove skin",
  "feature.appearance.appSkin.applied": "Skin applied",
  "feature.appearance.appSkin.resetDone": "Skin removed",
  "feature.appearance.appSkin.invalid": "Please choose a valid image file",
  "feature.appearance.appSkin.tooLarge": "Image is too large. Please choose an image under 24 MB.",
  "feature.appearance.appSkin.opacity": "Skin strength",
  "feature.appearance.appSkin.opacityHint": "How strongly the image shows through. Panels never drop below 62% opaque, so text stays legible at any setting.",
  ...
  "billing.windowSpend": "Last 30 days",
  "billing.totalSpend": "Total spent",
  "billing.calls": "calls",
  "billing.daily": "Daily spend",
  "billing.peak": "Peak",
  "billing.since": "onward",
  ...
  "billing.cost": "Cost",
  "billing.points": "pts",
  "billing.src.free": "free pts",
  "billing.src.mixed": "free pts + balance",
  "billing.src.paid": "balance",
  "billing.empty": "No activity yet",
  "billing.prev": "Previous page",
  "billing.next": "Next page",
  "billing.fromRecent": "from the last 200 entries",
  "billing.loadFailed": "Could not load billing",
  "common.close": "Close",
  "sessions.title": "Sessions",
  "sessions.subtitle": "Older messages stay in context as summaries — this is not only what is still on screen.",
  "sessions.search": "Search sessions, projects, file evidence…",
  "sessions.scopeProject": "Only",
  "sessions.scopeAll": "All projects",
  "sessions.empty": "No sessions yet",
  "sessions.noMatch": "No matching sessions",
  "sessions.noneInProject": "No sessions in this project yet",
  "sessions.today": "Today",
  "sessions.yesterday": "Yesterday",
  "sessions.week": "Last 7 days",
  "sessions.older": "Earlier",
  "sessions.turns": "turns",
  "sessions.msgs": "msgs",
  "sessions.files": "files",
  "sessions.corrections": "corrections",
  "sessions.untitled": "(untitled session)",
  "caps.title": "Capabilities",
  "caps.subtitle": "Tools, knowledge folders, roles and commands you wired in yourself.",
  "caps.desktopOnly": "Capability declarations only take effect in the desktop app.",
  "caps.errTitle": "Declarations that did not take effect",
  "caps.errTail": "Everything else still applies. Fix the file and reopen this panel — no restart needed.",
  "caps.tools": "Tools",
  "caps.knowledge": "Knowledge",
  "caps.roles": "Roles",
  "caps.commands": "Commands",
  "caps.disabled": "Disabled built-ins",
  "caps.files": "Config files",
  "caps.noTools": "None yet. “New example” below gives you one you can edit and use.",
  "caps.noKnowledge": "None yet. Point at a local folder and the model can search inside it.",
  "caps.noRoles": "None yet. A role can carry its own prompt and tool set.",
  "caps.noCommands": "None yet. Write one and it shows up when you press / in the composer.",
  "caps.noDisabled": "No built-in tools are turned off.",
  "caps.roleNoTools": "prompt only, no extra tools",
  "caps.scopeUser": "Personal · every project",
  "caps.scopeProject": "Project · travels with the repo",
  "caps.scopeLocal": "Project · yours only, do not commit",
  "caps.open": "Open",
  "caps.newExample": "New example",
  "caps.hint": "On a name clash the first one read wins (personal > project); “disabled” is a union — one layer saying no is enough. Changes apply within 10 seconds.",
  "caps.fileMissing": "That file does not exist yet — use “New example” to create one",
  "caps.fileHasContent": "That file already has content; opening it to edit instead of overwriting",
  "caps.seeded": "Moved your old config here verbatim; the old file is still there and can be deleted once you are happy",
  "caps.created": "Example created — change it to your own endpoint",
  "caps.createFailed": "Could not create",
  "browser.note.extIgnored": "{n} browser extension(s) are configured, but Chrome 137+ no longer accepts extensions loaded from the command line, so they will NOT take effect. Switch the automation browser to Edge / Brave / Chromium to use them (install one first if you do not have it).",
  "browser.note.attachedOwnApp": "Attached to {who}'s window ({brand}, debug port {port}) — this is the app the user is developing, so every later browser action targets it; close only detaches, it does not quit the app.",
  "stream.mseSessionGone": "Encrypted stream arrived, but the session that sealed it is no longer here (it was rotated or invalidated mid-flight). The ciphertext was NOT parsed as plaintext — just retry.",
  "memory.title": "Memory",
  "memory.core.title": "Core memory",
  "memory.thisProject": "this project",
  "memory.clear": "Clear",
  "memory.core.tagHint": " Lines tagged [你记的] were written by the assistant — delete the tag to keep one.",
  "memory.subtitle": "One entry per line. Project memory applies here; preferences travel with you.",
  "memory.tab.memory": "Project memory",
  "memory.tab.preferences": "Preferences",
  "memory.lines": "lines",
  "memory.everyProject": "every project",
  "memory.noFolder": "no folder open",
  "memory.usage": "Usage",
  "memory.save": "Save",
  "memory.core.hint": "Always in context, every turn. Rules and preferences, not notes — shorter works better.",
  "memory.core.minePlaceholder": "Reply in Chinese\nKeep answers short, lead with the conclusion",
  "memory.core.projectPlaceholder": "Goal: a booking site for one cinema\nAPI prefix is /api/v2\nMoney is stored in cents",
  "memory.project.hint": "Applies to this project only, retrieved by relevance — turns that do not need it do not pay for it.",
  "memory.project.placeholder": "This project uses pnpm\nUI goes through shadcn/ui",
  "memory.prefs.hint": "Travels with you across projects. How you want work done, not facts about this repo.",
  "memory.prefs.placeholder": "Answer truthfully\nVerify a fix before calling it done",
  "memory.stat.coreUser": "Core entries (every project)",
  "memory.stat.coreProject": "Core entries (this project)",
  "memory.stat.renderCore": "Turns that carried the core block",
  "memory.stat.captured": "Core entries captured from what you said",
  "memory.stat.reflectOpened": "Run-end reflections that considered memory",
  "memory.stat.reflectAccepted": "Entries those reflections wrote",
  "memory.stat.kgHit": "Turns with a relevant memory hit",
  "memory.stat.kgEmpty": "Turns with no relevant memory hit",
  "memory.stat.epHit": "Turns with a matching past task",
  "memory.stat.wfHit": "Turns with a matching workflow",
  ...
  "login.newPasswordPlaceholder": "New password (at least 6 characters)",
  "login.resetHint": "We emailed a code to {email}. Enter it with your new password.",
  "login.completeReset": "Set new password and sign in",
...
const ZH_CN = {
  ...
  "tool.action.office_write": "生成文档",
  "tool.action.office_edit": "修改文档",
  "tool.action.office_read": "读取文档",
  ...
  "assistant.prompt.initMemory": "通读这个项目：README、依赖与构建配置、目录结构、入口文件，以及它怎么跑、怎么测。然后用 remember 工具（scope 选 project）把长期有用的事实存进项目记忆：技术栈和版本、架构决定、目录与命名约定、确切的构建/测试/运行命令，以及你踩到的坑连同它的根因。一次存一条。最后列出你存了哪些。",
  "assistant.prompt.securityReview": "对这个项目**自己的代码**（不含依赖）做一次安全审查：注入面（SQL / 命令 / 路径 / 模板）、认证与鉴权的缺口、提交进仓库的密钥凭据、不安全的反序列化、SSRF，以及任何外部可达入口上缺失的输入校验。每一条给出文件和行号、为什么可被利用、以及最小的修法。指不到具体代码的就别写。",
  "assistant.prompt.listTodos": "在这个项目里找出 TODO / FIXME / HACK / XXX 这些标记，以及看起来已经废弃的、被注释掉的代码。按区域分组，说清每一条实际要求做什么，并按「不做的代价」排序。其中已经因为周围代码变了而失效的，单独指出来。",
  ...
  "feature.appearance.appSkin.section": "软件皮肤",
  "feature.appearance.appSkin.label": "自定义软件皮肤",
  "feature.appearance.appSkin.hint": "上传一张图片铺在整个 IDE 后面。外框会半透让它透出来；代码区始终是实底，任何时候都不会更难读。",
  "feature.appearance.appSkin.upload": "上传图片",
  "feature.appearance.appSkin.replace": "更换图片",
  "feature.appearance.appSkin.processing": "处理中…",
  "feature.appearance.appSkin.reset": "移除皮肤",
  "feature.appearance.appSkin.applied": "皮肤已应用",
  "feature.appearance.appSkin.resetDone": "皮肤已移除",
  "feature.appearance.appSkin.invalid": "请选择一张有效的图片",
  "feature.appearance.appSkin.tooLarge": "图片太大了，请选择 24 MB 以内的图片。",
  "feature.appearance.appSkin.opacity": "皮肤浓度",
  "feature.appearance.appSkin.opacityHint": "图片透出来的强度。面板最低保留 62% 不透明度，所以拉到哪一档正文都还读得清。",
  ...
  "billing.loading": "加载中...",
  "billing.balance": "余额",
  "billing.windowSpend": "近 30 天",
  "billing.totalSpend": "累计消费",
  "billing.calls": "次调用",
  "billing.daily": "每日消费",
  "billing.peak": "峰值",
  "billing.since": "起",
  ...
  "billing.cost": "费用",
  "billing.points": "点",
  "billing.src.free": "免费点",
  "billing.src.mixed": "免费点+额度",
  "billing.src.paid": "额度·钱包",
  "billing.empty": "暂无记录",
  "billing.prev": "上一页",
  "billing.next": "下一页",
  "billing.fromRecent": "按最近 200 条明细统计",
  "billing.loadFailed": "账单加载失败",
  "common.close": "关闭",
  "sessions.title": "会话",
  "sessions.subtitle": "更早的对话会压成摘要留在上下文里，不只是屏幕上还看得见的那些。",
  "sessions.search": "搜索会话、项目、文件线索…",
  "sessions.scopeProject": "只看",
  "sessions.scopeAll": "全部项目",
  "sessions.empty": "还没有会话",
  "sessions.noMatch": "没有匹配的会话",
  "sessions.noneInProject": "这个项目下还没有会话",
  "sessions.today": "今天",
  ...
  "sessions.msgs": "条",
  "sessions.files": "文件",
  "sessions.corrections": "纠正",
  "sessions.untitled": "（未命名会话）",
  "caps.title": "能力",
  "caps.subtitle": "你自己接进来的工具、知识库、角色和命令。",
  "caps.desktopOnly": "能力声明只在桌面 App 里生效。",
  "caps.errTitle": "声明没有生效",
  "caps.errTail": "其余声明照常生效。改完文件回到这里再看一次即可，不用重启。",
  "caps.tools": "工具",
  "caps.knowledge": "知识库",
  "caps.roles": "角色",
  "caps.commands": "命令",
  "caps.disabled": "已关闭的内置工具",
  "caps.files": "配置文件",
  "caps.noTools": "还没有。下面「新建示例」会给你一份改改就能用的。",
  "caps.noKnowledge": "还没有。指一个本地目录，模型就能在里面检索。",
  "caps.noRoles": "还没有。角色可以带自己的提示词和工具矩阵。",
  "caps.noCommands": "还没有。写一条就能在输入框里按 / 唤出来。",
  "caps.noDisabled": "没有关掉任何内置工具。",
  "caps.roleNoTools": "只有提示词，没有额外工具",
  "caps.scopeUser": "个人 · 所有项目通用",
  "caps.scopeProject": "项目 · 跟着仓库走，团队共享",
  "caps.scopeLocal": "项目 · 只属于你，别提交",
  "caps.open": "打开",
  "caps.newExample": "新建示例",
  "caps.hint": "同名的以先读到的为准（个人 > 项目）；「已关闭」取并集——任一层说别用就算数。改完 10 秒内自动生效。",
  "caps.fileMissing": "这个文件还不存在，点「新建示例」先建一份",
  "caps.fileHasContent": "这个文件已经有内容了，直接打开来改，不覆盖",
  "caps.seeded": "已把你原来的配置搬到这里，内容一字未改；旧文件还在，确认没问题后可以删掉",
  "caps.created": "已建好一份示例，改成你自己的接口即可",
  "caps.createFailed": "建不了",
  "browser.note.extIgnored": "配了 {n} 个浏览器扩展，但 Chrome 从 137 起已经不再接受命令行加载扩展，这些扩展**不会生效**。要用扩展得把自动化浏览器换成 Edge / Brave / Chromium（本机没装的话要先装）。",
  "browser.note.attachedOwnApp": "已接管 {who} 的窗口（{brand}，调试端口 {port}）——这是用户自己在开发的应用，后面每个 browser 动作都作用在它上面；close 只断开连接，不会关掉应用。",
  "stream.mseSessionGone": "收到密文流，但封它的那个会话已经不在本地了（会话在途中被轮换或作废）。没有把密文当明文解析——重试一次即可。",
  "memory.title": "记忆",
  "memory.core.title": "核心记忆",
  "memory.thisProject": "这个项目",
  "memory.clear": "清空",
  "memory.core.tagHint": "以 [你记的] 开头的是助手写的，删掉标记就当作你自己的。",
  "memory.subtitle": "每行一条。项目记忆只在当前项目生效，偏好设置跟着你走。",
  "memory.tab.memory": "项目记忆",
  "memory.tab.preferences": "偏好设置",
  "memory.lines": "行",
  "memory.everyProject": "所有项目",
  "memory.noFolder": "还没打开文件夹",
  "memory.usage": "使用情况",
  "memory.save": "保存",
  "memory.core.hint": "每一轮都在上下文里。写规则和偏好，别写笔记 —— 越短越管用。",
  "memory.core.minePlaceholder": "回复用中文\n答案短一点，先说结论",
  "memory.core.projectPlaceholder": "目标：给一家影院做订票站\n接口前缀是 /api/v2\n金额一律存分",
  "memory.project.hint": "只在这个项目里生效，按相关性检索 —— 用不上的那几轮不会占上下文。",
  "memory.project.placeholder": "这个项目用 pnpm\n界面走 shadcn/ui",
  "memory.prefs.hint": "跟着你走，换项目也在。写做事的方式，不写这个项目的事实。",
  "memory.prefs.placeholder": "有一说一，别糊弄\n说「修好了」之前先自己验一遍",
  "memory.stat.coreUser": "核心条目（所有项目）",
  "memory.stat.coreProject": "核心条目（这个项目）",
  "memory.stat.renderCore": "带上核心块的轮次",
  "memory.stat.captured": "从你的话里记下的核心条目",
  "memory.stat.reflectOpened": "收尾时回看过记忆的轮次",
  "memory.stat.reflectAccepted": "那些回看写下的条目",
  "memory.stat.kgHit": "检索到相关记忆的轮次",
  "memory.stat.kgEmpty": "没有相关记忆的轮次",
  "memory.stat.epHit": "命中过往任务的轮次",
  "memory.stat.wfHit": "命中工作流的轮次",
  ...
  "login.forgot": "忘记密码？",
  "login.newPasswordPlaceholder": "设置新密码（至少 6 位）",
  "login.resetHint": "验证码已发到 {email}，输入验证码和新密码即可登录",
  "login.completeReset": "设置新密码并登录",
  "login.resetting": "重置中…",
  "login.back": "返回",
  "login.sending": "发送中…",
...
const JA = {
  ...
  "feature.appearance.appSkin.section": "アプリのスキン",
  "feature.appearance.appSkin.label": "カスタムスキン",
  "feature.appearance.appSkin.hint": "IDE 全体の背景に敷く画像をアップロードします。外枠が半透明になって画像が透けます。コード領域は常に不透明なので読みにくくなりません。",
  "feature.appearance.appSkin.upload": "画像をアップロード",
  "feature.appearance.appSkin.replace": "画像を変更",
  "feature.appearance.appSkin.processing": "処理中…",
  "feature.appearance.appSkin.reset": "スキンを削除",
  "feature.appearance.appSkin.applied": "スキンを適用しました",
  "feature.appearance.appSkin.resetDone": "スキンを削除しました",
  "feature.appearance.appSkin.invalid": "有効な画像ファイルを選んでください",
  "feature.appearance.appSkin.tooLarge": "画像が大きすぎます。24 MB 以内の画像を選んでください。",
  "feature.appearance.appSkin.opacity": "スキンの濃さ",
  "feature.appearance.appSkin.opacityHint": "画像の透け具合。パネルの不透明度は 62% を下回らないため、どの設定でも文字は読めます。",
  ...
  "billing.balance": "残高",
  "billing.windowSpend": "直近 30 日",
  "billing.totalSpend": "累計利用額",
  "billing.calls": "回",
  "billing.daily": "日別利用額",
  "billing.peak": "ピーク",
  "billing.since": "以降",
  "billing.byModel": "モデル別",
  "billing.other": "その他",
  "billing.detail": "明細",
  "billing.time": "日時",
  "billing.model": "モデル",
  ...
  "billing.cost": "料金",
  "billing.points": "ポイント",
  "billing.src.free": "無料ポイント",
  "billing.src.mixed": "無料ポイント+残高",
  "billing.src.paid": "残高",
  "billing.empty": "履歴はありません",
  "billing.prev": "前のページ",
  "billing.next": "次のページ",
  "billing.fromRecent": "直近 200 件の明細から集計",
  "billing.loadFailed": "請求情報を読み込めません",
  "common.close": "閉じる",
  "sessions.title": "セッション",
  "sessions.subtitle": "古いメッセージは要約としてコンテキストに残ります。画面に見えているものだけではありません。",
  "sessions.search": "セッション・プロジェクト・ファイルを検索…",
  "sessions.scopeProject": "このプロジェクト:",
  "sessions.scopeAll": "全プロジェクト",
  "sessions.empty": "セッションはまだありません",
  "sessions.noMatch": "一致するセッションがありません",
  "sessions.noneInProject": "このプロジェクトにはまだセッションがありません",
  "sessions.today": "今日",
  "sessions.yesterday": "昨日",
  "sessions.week": "直近 7 日",
  "sessions.older": "それ以前",
  "sessions.turns": "ターン",
  "sessions.msgs": "件",
  "sessions.files": "ファイル",
  "sessions.corrections": "修正",
  "sessions.untitled": "（無題のセッション）",
  "caps.title": "機能",
  "caps.subtitle": "自分で追加したツール・ナレッジ・ロール・コマンド。",
  "caps.desktopOnly": "機能宣言はデスクトップアプリでのみ有効です。",
  "caps.errTitle": "有効になっていない宣言",
  "caps.errTail": "他の宣言はそのまま有効です。ファイルを直してここを開き直すだけで反映されます。",
  "caps.tools": "ツール",
  "caps.knowledge": "ナレッジ",
  "caps.roles": "ロール",
  "caps.commands": "コマンド",
  "caps.disabled": "無効化した組み込みツール",
  "caps.files": "設定ファイル",
  "caps.noTools": "まだありません。下の「サンプル作成」で雛形が作れます。",
  "caps.noKnowledge": "まだありません。ローカルフォルダーを指定すると検索できます。",
  "caps.noRoles": "まだありません。ロールは専用のプロンプトとツールを持てます。",
  "caps.noCommands": "まだありません。1 つ書くと入力欄で / から呼び出せます。",
  "caps.noDisabled": "無効化した組み込みツールはありません。",
  "caps.roleNoTools": "プロンプトのみ、追加ツールなし",
  "caps.scopeUser": "個人 · 全プロジェクト",
  "caps.scopeProject": "プロジェクト · リポジトリと一緒に",
  "caps.scopeLocal": "プロジェクト · 自分専用（コミットしない）",
  "caps.open": "開く",
  "caps.newExample": "サンプル作成",
  "caps.hint": "同名は先に読まれた方が優先（個人 > プロジェクト）。「無効化」は和集合——どこか 1 つでも無効なら無効です。変更は 10 秒以内に反映されます。",
  "caps.fileMissing": "このファイルはまだありません。「サンプル作成」で作ってください",
  "caps.fileHasContent": "すでに内容があります。上書きせずそのまま開きます",
  "caps.seeded": "以前の設定をそのまま移しました。元のファイルは残っています",
  "caps.created": "サンプルを作成しました。自分のエンドポイントに書き換えてください",
  "caps.createFailed": "作成できません",
  "browser.note.extIgnored": "ブラウザ拡張を {n} 個設定していますが、Chrome 137 以降はコマンドラインからの拡張読み込みを受け付けないため、これらは**動作しません**。拡張を使うには自動化ブラウザを Edge / Brave / Chromium に変えてください（未インストールなら先に導入が必要です）。",
  "browser.note.attachedOwnApp": "{who} のウィンドウに接続しました（{brand}、デバッグポート {port}）。これはユーザーが開発中のアプリなので、以降の browser 操作はすべてこれに対して行われます。close は接続を切るだけで、アプリは終了しません。",
  "stream.mseSessionGone": "暗号化ストリームを受信しましたが、それを封じたセッションがローカルに残っていません（途中でローテーションまたは無効化されました）。暗号文を平文として解析はしていません。もう一度試してください。",
  "memory.title": "メモリ",
  "memory.core.title": "コアメモリ",
  "memory.thisProject": "このプロジェクト",
  "memory.clear": "消去",
  "memory.core.tagHint": "[你记的] で始まる行はアシスタントが書いたものです。",
  "memory.subtitle": "1 行に 1 件。プロジェクトメモリはこのプロジェクトのみ、設定はどこでも有効です。",
  "memory.tab.memory": "プロジェクトメモリ",
  "memory.tab.preferences": "設定",
  "memory.lines": "行",
  "memory.everyProject": "全プロジェクト",
  "memory.noFolder": "フォルダー未選択",
  "memory.usage": "利用状況",
  "memory.save": "保存",
  "memory.core.hint": "毎ターン必ず読み込まれます。メモではなくルールと好みを、短く。",
  "memory.core.minePlaceholder": "日本語で答える\n結論から短く",
  "memory.core.projectPlaceholder": "目的：映画館の予約サイト\nAPI の接頭辞は /api/v2\n金額はセント単位で保存",
  "memory.project.hint": "このプロジェクトだけに適用され、関連度で取り出されます。",
  "memory.project.placeholder": "このプロジェクトは pnpm を使う\nUI は shadcn/ui",
  "memory.prefs.hint": "プロジェクトをまたいで有効。仕事の進め方を書き、リポジトリの事実は書かない。",
  "memory.prefs.placeholder": "正直に答える\n直したと言う前に自分で検証する",
  "memory.stat.coreUser": "コア項目（全プロジェクト）",
  "memory.stat.coreProject": "コア項目（このプロジェクト）",
  "memory.stat.renderCore": "コアを載せたターン",
  "memory.stat.captured": "発言から記録したコア項目",
  "memory.stat.reflectOpened": "終了時にメモリを見直したターン",
  "memory.stat.reflectAccepted": "その見直しが書いた項目",
  "memory.stat.kgHit": "関連メモリに当たったターン",
  "memory.stat.kgEmpty": "関連メモリがなかったターン",
  "memory.stat.epHit": "過去タスクに一致したターン",
  "memory.stat.wfHit": "ワークフローに一致したターン",
  ...
  "login.newPasswordPlaceholder": "新しいパスワード（6文字以上）",
  "login.resetHint": "{email} に確認コードを送りました。コードと新しいパスワードを入力してください",
  "login.completeReset": "新しいパスワードを設定してログイン",
...
const AUTO_I18N_SKIP_SELECTOR = [
  ...
  "[contenteditable]",
  "[data-i18n-skip]",
  // 标准 HTML 的「别翻这块」。写它比写 data-i18n-skip 更对：浏览器自己的翻译、以及将来任何
  // 别的翻译器都认同一个属性，组件不用知道我们内部叫什么。
  '[translate="no"]',
  "#editor",
  "#terminal",
  "#tree",
...
// 导出只为可测：它是个纯判据，测试直接 import 来跑真行为，
// 而不是在测试里手抄一份「按名字抠函数体」的提取器（那有专门的守卫拦着）。
export function looseUiTextEligible(text) {
  const s = normalizeUiText(text);
  if (s.length < 2 || s.length > 260) return false;
  if (/^[\d\s.,:;()[\]{}+\-*/%|\\]+$/.test(s)) return false;
  // **带单位的数字不是文案。** "1.8k" 只因为那个 k 是字母就通过了下面那道「必须含字母」的
  // 闸，被当成一句话送去翻译，回来是 "1.8千" —— 2026-09-07 账单表格实拍：同一列里
  // "2.0k" 和 "1.8千" 并排（翻没翻取决于缓存和这一批次赶没赶上），像是随手写的。
  // 数字 + 至多两位字母的形状一律不翻：1.8k / 27.5M / 120ms / 16px / $0.005 / 58%。
  if (/^[$€¥£]?[\d][\d\s.,]*\s?[A-Za-z%]{0,2}$/.test(s)) return false;
