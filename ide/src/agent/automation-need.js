...
const DIAG_RE = new RegExp([
  ...
  // 友善的说法和尖锐的说法说的是同一件事。原来只认「丑 / 难看」，于是「这个页面太丑了改一下」
  // 会挂上设计验收（含「不够好就再改、两三轮打磨」那段审美闭环），而「把这个按钮改好看点」
  // 档位是 none、整块不挂、还被禁止去浏览器里看一眼。同一个诉求，措辞客气反而被敷衍。
  "改好看", "改漂亮", "变好看", "不好看", "美化", "精致", "质感", "高级感", "不协调", "不统一", "视觉升级",
